...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240417_o1standard_950030b9d59f2a726336_20240529073557_archive.daf';
        const ARCHIVE_SIZE       = '1783122';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '950030b-29073557';
        const SECONDARY_PACKAGE_HASH = '018c1e9-29073557';
        const VERSION            = '1.5.9';
